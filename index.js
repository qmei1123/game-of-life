...
var rX=Math.floor(Math.random()*500),
                gX=Math.floor(Math.random()*500),
                bX=Math.floor(Math.random()*500),
                aX=(Math.floor(Math.random()*6)+10)/10; // rand between 0.5 and 1.0
var rY=Math.floor(Math.random()*150),
                gY=Math.floor(Math.random()*150),
                bY=Math.floor(Math.random()*150),
                aY=(Math.floor(Math.random()*6)+5)/10; // rand between 0.5 and 1.0
...
function draw_cells(context, cells) {
    ...
    for (i = 0; i < cells['rows']; i++) {
        for (j = 0; j < cells['cols']; j++) {
            if (cells[i][j] === 1) {
                context.fillStyle = 'rgba(' + rY + ',' + gY + ',' + bY + ',' + aY + ')';
            } else {
                context.fillStyle = 'rgba(' + rX + ',' + gX + ',' + bX + ',' + aX + ')';
            }
